...
public final class ModAchievements {
	...
	public static void init() {
		craft_basic_wand = new AchievementMod(AchievementNames.CRAFT_BASIC_WAND, 0, 0, ModItems.basic_wand_copper, craft_basic_wand);
		...
		enhanced_progression_page = new AchievementPage(Reference.NAME, AchievementMod.achievements.toArray(new Achievement[AchievementMod.achievements.size()]));
