 ...
 */
package com.raphydaphy.enhancedprogression.block.multiblock;
...
public class Multiblock
{
	...
	public final HashMap<BlockPos, MultiblockComponent> locationCache = new HashMap<BlockPos, MultiblockComponent>();
