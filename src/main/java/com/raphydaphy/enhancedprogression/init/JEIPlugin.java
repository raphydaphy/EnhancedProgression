...
public class JEIPlugin implements IModPlugin
{
	...
	public void register(IModRegistry registry)
	{
		...
		registry.addDescription(new ItemStack(ModItems.spell_card_fireball), "For the cost of 40 essence, this spell summons a fireball that shoots off in the direction you are looking. Be careful around your house and other valuable things, because this will destroy anything that it touches!");
		registry.addDescription(new ItemStack(ModItems.spell_card_explosion),
