...
public class ModRecipies
{
	public static void registerCrafting()
	{
		...
		GameRegistry.addShapedRecipe(new ItemStack(ModItems.basic_wand_copper), "  C", " S ", "S  ", 'S', Items.STICK,
				'C', ModItems.ingot_copper);
		GameRegistry.addShapedRecipe(new ItemStack(ModItems.basic_wand_tin), "  C", " S ", "S  ", 'S', Items.STICK, 'C',
				ModItems.ingot_tin);
		...
		GameRegistry.addShapedRecipe(new ItemStack(ModItems.spell_card_explosion), "SGS", "GBG", "SGS", 'S',
				Items.STICK, 'G', Items.GUNPOWDER, 'B', ModItems.ingot_bronze);
		...
		GameRegistry.addShapedRecipe(new ItemStack(ModItems.spell_card_transmutation), "SBS", "BIB", "SBS", 'S',
