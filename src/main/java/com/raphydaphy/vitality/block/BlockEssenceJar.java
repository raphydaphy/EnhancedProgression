...
public class BlockEssenceJar extends BlockBase implements ITileEntityProvider, IWandable
{
    ...
    protected static final AxisAlignedBB AABB_KNOB = new AxisAlignedBB(0.3125D, 0.875D, 0.3125D, 0.5625D, 1.0D, 0.5625D);
                    ...
                    EnumHand hand, ItemStack heldItem, EnumFacing side, float hitX, float hitY, float hitZ) 
    {
    	...
    	else if (!world.isRemote)
        {
            ...
            {
            	// TODO: make this work for any IEssenceContainer inventory type so it works with other future vial types
