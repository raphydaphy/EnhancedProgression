...
public class BlockModOre extends BlockBase
{
    ...
    {
        return this == ModBlocks.angelic_crystal_ore ? ModItems.angelic_crystal_shard : (this == ModBlocks.exotic_crystal_ore ? ModItems.exotic_crystal_shard: Item.getItemFromBlock(this));
    }
