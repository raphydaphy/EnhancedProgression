...
public class JEIPlugin implements IModPlugin
{
	...
	public void register(IModRegistry registry)
	{
		...
		registry.addDescription(new ItemStack(ModItems.spell_card_fertilization_1), "For 100 essence, this spell will fertilize the crop you are looking at the same as if you used bonemeal.");
		registry.addDescription(new ItemStack(ModItems.spell_card_fertilization_2), "For 50 essence, this spell will grow the crop you are looking at the same as if you used bonemeal.");
		registry.addDescription(new ItemStack(ModItems.spell_card_fertilization_3), "This spell performs the same as the Renewed and Imbued Fertilization spells, yet it only costs 25 essence to use.");
		registry.addDescription(new ItemStack(ModItems.spell_card_placement_1), "This spell will place blocks in mid-air for 50 essence each. You can set the blocks to be either dirt, cobblestone or oak planks by shift + right-clicking on one of those blocks with the spell equipped in your offhand and your wand in your main hand.");
		registry.addDescription(new ItemStack(ModItems.spell_card_placement_2), "This functions the same as the Angelic Placement spell, however only costs 25 essence per use.");
		registry.addDescription(new ItemStack(ModItems.spell_card_placement_3), "This spell will function the same as the Angelic and Imbued variants, yet only costs 10 essence per use.");
		...
		registry.addDescription(new ItemStack(ModItems.spell_bag), "Crafted by right-clicking a bookshelf with a wand while the Cryptic Transmutation spell is active, this item can be crafted together with any spell in a normal crafting table to add it to the bag. Press O, or whatever you set the key to in the Controls menu, and you will see a GUI that lets you select a spell to cast.");
	}
