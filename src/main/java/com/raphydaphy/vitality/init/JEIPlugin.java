...
public class JEIPlugin implements IModPlugin
{
	...
	public void register(IModRegistry registry)
	{
		...
		registry.addDescription(new ItemStack(ModItems.spell_card_fertilization_3), "This spell performs the same as the Renewed and Imbued Fertilization spells, yet it only costs 25 essence to craft.");
