...
public class ItemVial extends ItemBase{
	 ...
	 * @param maxStored - The maximum amount this vial can hold.
	 */
	 ...
	 * @param type - The Essence type.
	 * @param maxStored - The maximum amount this vial can hold.
	 * @param emptyVial - The item representing the Empty Vial for this group.
	 */
	public ItemVial(String name, @Nonnull Essence type, int maxStored, VialQuality quality, @Nonnull ItemVial emptyVial){
    ...
    {
       if(this.emptyVial != null) list.add(getFullVial());
	...
	public ActionResult<ItemStack> onItemRightClick(ItemStack stack, World worldIn, EntityPlayer player,
		...
		if (player.isSneaking()) 
		{
			...
			{
				ClientProxy.setActionText("Storing " + stack.getTagCompound().getInteger(Essence.KEY) + " / " + maxStored + " Essence",TextFormatting.DARK_PURPLE);
	...
	public void onUpdate(ItemStack stack, World world, Entity entity, int itemSlot, boolean isSelected) {
		...
		if (hasType() && !stack.hasTagCompound()) stack2 = new ItemStack(emptyVial); 
		else if (hasType() && stack.getTagCompound().getInteger(Essence.KEY) == 0) stack2 = new ItemStack(emptyVial);
	
	if(!ItemStack.areItemStacksEqual(stack, stack2)) ((EntityPlayer) entity).inventory.setInventorySlotContents(itemSlot, stack2);	
	}}
