...
public class ItemWand extends ItemBase
{
	...
	public ActionResult<ItemStack> onItemRightClick(ItemStack stack, World world, EntityPlayer player, EnumHand hand)
    {
		...
		{
			Vitality.proxy.setActionText("Storing " + stack.getTagCompound().getInteger("essenceStored") + " / " + stack.getTagCompound().getInteger("maxEssence") + stack.getTagCompound().getInteger("essenceType") + " Essence", TextFormatting.BOLD);
