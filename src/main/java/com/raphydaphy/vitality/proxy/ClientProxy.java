...
public class ClientProxy extends CommonProxy {
	...
	public void preInitDiff() {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(ModBlocks.essence_jar), 0,
				new ModelResourceLocation(new ResourceLocation("vitality", "essence_jar"), "inventory"));
		ModelLoader.registerItemVariants(ModItems.wand,
				new ModelResourceLocation(Reference.MOD_ID + ":wand", "inventory"));
