...
public class ModRecipies {
	...
	public static void registerCrafting() {
		addShapelessOreRecipe(new ItemStack(ModItems.INGOT_BRONZE, 4),"ingotCopper","ingotCopper","ingotCopper","ingotTin");
		...
		addOreDictRecipe(new ItemStack(ModItems.SPELL_EXCAVATION), " B ", "BPB", " B ", 'B', "ingotBronze", 'P', Items.IRON_PICKAXE);
		addOreDictRecipe(new ItemStack(ModItems.SPELL_EXPLOSION), " B ", "BPB", " B ", 'B', "ingotBronze", 'P', "gunpowder");
		addOreDictRecipe(new ItemStack(ModItems.SPELL_FIREBALL), " B ", "BPB", " B ", 'B', "ingotBronze", 'P', Items.FIRE_CHARGE);
		addOreDictRecipe(new ItemStack(ModItems.SPELL_ILLUMINATION), " B ", "BPB", " B ", 'B', "ingotBronze", 'P', "itemBasicFuel");
