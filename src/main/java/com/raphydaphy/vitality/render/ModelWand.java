    ...
    protected static class BakedWand implements IPerspectiveAwareModel
    {
        ...
        public Pair<? extends IBakedModel, Matrix4f> handlePerspective(TransformType cameraTransformType)
        {
        	...
        	else if (cameraTransformType == TransformType.THIRD_PERSON_LEFT_HAND)
        	{
				...
				//TRSRTransformation tr = new TRSRTransformation(new Vector3f(0f,0f,0f), TRSRTransformation.quatFromXYZDegrees(new Vector3f(0f,0,0f)), new Vector3f(0.85f,0.85f,0.85f), TRSRTransformation.quatFromXYZDegrees(new Vector3f(0f,0,0f)));
				//Matrix4f mat = null;	
				//if(tr != null && !tr.equals(TRSRTransformation.identity())) mat = TRSRTransformation.blockCornerToCenter(tr).getMatrix();
				//return Pair.of(this, mat);
        	}
